const newsPolitics= document.getElementById('politicsnews')
...
$(document).ready(() => {
    $.ajax({
        type: "GET",
        url: "http://localhost/news/backend/selectpolitics.php",
        dataType: "html",
        success: (json) => {
